...
# Define Particles
particle_a = TccLib.Particle("A", (0.07 * mesh.length_x, mesh.length_y), density=5.4e5, diameter=5e-5)
...
for time in x_vector:
    ...
    TccLib.move_particles(mesh, velocity_x=vel_x, velocity_y=vel_y, dt=dt, single_force="gravitational")
...
TccLib.util.show_comparison(x_vector, analytic_expression, y_vector, numeric_label="Solução Numérica",
                            ...
                            save_file_as="{0}_gravitational_validation".format(mesh.name))
