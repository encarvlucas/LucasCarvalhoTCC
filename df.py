...
def main():
	...
	# 	T_inicial = diferencasfinitasexplicito(X, MRE, 1.0, Q, t_intervalos[i], T_inicial, None, None)
	...
	T_inicial = diferencasfinitasimplicito(X, MRE, 1.0, Q, t_intervalos, T_inicial, None, None)
	grafico(X, T_inicial, "b", "Metodo Teste")
	plt.show()
	return
