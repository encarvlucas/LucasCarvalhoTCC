...
\begin{frame}
  \frametitle{\subsecname}
  %-Primeiro falaremos sobre a equação de Naiver-Stokes e esta forma e obtida através dela
...
\begin{frame}
  \frametitle{\subsecname}
  %-Esta formulação e uma alternativa a equação de Navier-Stokes para encontrar o campo de velocidades do escoamento
