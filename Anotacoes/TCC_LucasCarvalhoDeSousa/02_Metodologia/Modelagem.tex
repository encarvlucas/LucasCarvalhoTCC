...
São tomadas as hipóteses do fluido como um meio contínuo, fluido imcompressível, e das partículas perfietamente rígidas.
%--------------------------------------------------------------
...
As matrizes utilizadas foram obtidas por Lewis, Nithiarasu e Seetharamu (2004)\cite{lewis}.
