...
Foram escolhidas apenas as principais forças, apresentadas a seguir\cite{crowe}: 
\begin{itemize}
    ...
    \item \textbf{Força de Sustentação}:
        ...
        Porém outro tipo de força de sustentação é a \textbf{Força de Saffman}\cite{crowe}, que é gerada a partir do gradiente de velocidades presente no escoamento.
